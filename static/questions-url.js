...
function getScoreImpact(questionId, answer) {
    switch (questionId) {
        case 'question1':
            return answer ? -20 : 5; // Perte de 10 points pour "Oui", gain de 5 points pour "Non"
        case 'question2':
            return answer ? 9 : -10; // Gain de 10 points pour "Oui", perte de 5 points pour "Non"
        case 'question3':
            return answer ? -15 : 5; // Perte de 20 points pour "Oui", gain de 4 points pour "Non"
        default:
            return 0;
    }
}
...
function endQuestionnaire(confidence) {
    if (confidence > 80) {
        ...
        document.getElementById('paragraphe2').innerHTML = "Cela signifie que votre url est relativement sûr, mais elle peut présenter des risques potentiels. Nous vous recommandons de vérifier attentivement l'url avant de cliquer dessus et de suivre les bonnes pratiques de sécurité pour minimiser les risques."
        ...
        document.getElementById('paragraphe2').innerHTML = "Cela indique qu'il y a un certain risque potentiel associé à cette url. Nous vous recommandons de faire preuve de prudence et de vérifier plus en détail avant de l'ouvrir ou de l'utiliser."
        ...
        document.getElementById('paragraphe2').innerHTML = "Cela signifie que l'url présente des risques de sécurité significatifs. Nous vous conseillons vivement de ne pas ouvrir cette url. Assurez-vous de suivre les protocoles de sécurité appropriés pour protéger vos données."
        ...
        document.getElementById('paragraphe2').innerHTML = "Cela signifie que l'url est considéré comme dangereux et que cela présente des risques élevés de sécurité. Nous vous recommandons de ne pas cliquer sur cette url"
